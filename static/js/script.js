...
function upiPay() {
  ...
  document.getElementById('razorpayBtnWrap').style.display = 'none';
  document.getElementById('payProcessing').style.display = 'block';
  document.getElementById('payProcessing').innerHTML = '<div style="font-size:14px;color:#B5797A;font-weight:600;margin-bottom:8px">Pay &#8377;99 via UPI</div><div style="font-size:13px;color:#555;margin-bottom:6px">UPI ID: <strong>' + upiId + '</strong></div><div style="font-size:12px;color:#888;margin-bottom:16px">Open your UPI app and pay &#8377;99 to the above ID. Then click confirm.</div><button onclick="window.open(\'' + upiLink + '\',\'_blank\')" style="width:100%;padding:10px;border:2px solid #B5797A;border-radius:50px;background:#fff;color:#B5797A;font-weight:600;margin-bottom:8px;cursor:pointer;font-size:13px">Open UPI App</button><button onclick="confirmBooking().then(function(){document.getElementById(\'payProcessing\').style.display=\'none\';document.getElementById(\'paySuccess\').style.display=\'block\';var d=getBookingData();document.getElementById(\'confirmText\').innerHTML=d.service_name+\'<br>\'+d.date+\' at \'+d.time})" class="btn-primary" style="width:100%;padding:11px;font-size:14px;border:none;border-radius:50px;cursor:pointer;color:#fff;background:#25D366;font-weight:600">&#10003; I\'ve Paid — Confirm Booking</button><button onclick="document.getElementById(\'payProcessing\').style.display=\'none\';document.getElementById(\'razorpayBtnWrap\').style.display=\'block\'" style="width:100%;padding:9px;border:none;border-radius:50px;background:transparent;color:#999;margin-top:6px;cursor:pointer;font-size:13px">&#8592; Back to payment options</button>';
